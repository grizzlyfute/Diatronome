...
public class MetronomeView extends View
{
  ...
  public MetronomeView(Context context, AttributeSet attrs)
  {
    ...
    m_animator.addUpdateListener(new BasicAnimator.AnimatorUpdateListener()
    {
      ...
      {
        setAnimatedAngle (animatedValueDegree);
      }
    });
  ...
  public void setAngle(double angleDeg, long durationMs)
  {
    float wantedDegree;
    ...
    {
      setAnimatedAngle(wantedDegree);
    }
  }

  private void setAnimatedAngle(float angleDeg)
  {
